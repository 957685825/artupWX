<template>
	<div id="fileLoad">
		...
		<!--<mt-popup style="position;relative;" v-model="isOk">
			<div class="mint-indicator-wrapper" style="padding: 20px;">
				<span class="mint-indicator-spin">
					<div class="mint-spinner-fading-circle circle-color-35" style="width: 32px; height: 32px;">
						...
						</div><div class="mint-spinner-fading-circle-circle is-circle7"></div>
					...
					<span class="mint-indicator-text">继续编辑中...</span></div>
		</mt-popup>-->
	</div>
</template>
